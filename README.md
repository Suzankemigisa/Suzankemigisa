...
![OpenAI](https://img.shields.io/badge/Multi--LLM_Integrations-412991?style=for-the-badge&logo=openai&logoColor=white)
![NLP](https://img.shields.io/badge/NLP-033E5B?style=for-the-badge)
...
|---------|-------------|-------|
| 💰 **FinAdvisor AI** | AI-powered financial advisor for African markets — multi-LLM chat, AI agents with goal awareness, email notifications | Next.js · LLMs · Zustand |
| 🤰 **MamaCare** | Maternal health AI assistant for rural Uganda via USSD, SMS & Voice — led backend architecture for a team of 8 | NestJS · Supabase · Africa's Talking |
| 🛡️ **Aegis Haven** | Domestic violence support chatbot with RAG pipeline, panic button & multilingual detection (English, Luganda, Swahili) | Next.js · RAG |
| 🎙️ **Voxel** | Voice intelligence mobile app for Ugandan English & Luganda speakers | React Native · FastAPI · Modal GPU |
| ✅ **Todo Monorepo** | Full-stack task app with JWT auth, Google OAuth, subtasks & recurring tasks | Remix · NestJS · Prisma |
